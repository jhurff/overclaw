        ...
        this.ws.on('open', () => {
            ...
            this.ws.send(JSON.stringify({
                ...
                params: {
                    ...
                    // device: {
                    //     id: 'overclaw-device', // A stable ID for this OverClaw instance
                    //     publicKey: '', // Public key for device authentication (more advanced)
                    //     signature: '', // Signature for connect.challenge (more advanced)
                    //     signedAt: 0, // Timestamp for signature
